...
Name=NotClassic
Exec=env __GLX_VENDOR_LIBRARY_NAME=nvidia $GAME_DIR/NotClassic  
...
Exec=env __GLX_VENDOR_LIBRARY_NAME=nvidia $GAME_DIR/NotClassic --singleplayer

[Desktop Action resume]
Name=Resume last server
Exec=env __GLX_VENDOR_LIBRARY_NAME=nvidia $GAME_DIR/NotClassic --resume
EOF
